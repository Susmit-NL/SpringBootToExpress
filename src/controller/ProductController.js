...
var ProductController = /** @class */ (function () {
    ...
    ProductController.prototype.getAllProduct = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.a.getAllProducts()];
                    case 1:
                        product = _a.sent();
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        _b = (_a = res).send;
                        return [4 /*yield*/, this.a.create(new Product_1.Product(req.body.name, req.body.price, req.body.inventory, req.body.description))];
                    case 1:
                        _b.apply(_a, [_c.sent()]);
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        _b = (_a = res).send;
                        return [4 /*yield*/, this.a.update(new Product_1.Product(req.body.name, req.body.price, req.body.inventory, req.body.description), req.params.id)];
                    case 1:
                        _b.apply(_a, [_c.sent()]);
                        return [2 /*return*/];
                }
    ...
    ProductController.prototype.findById = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        _b = (_a = res).send;
                        return [4 /*yield*/, this.a.findById(Number(req.params.id))];
                    case 1:
                        _b.apply(_a, [_c.sent()]);
                        return [2 /*return*/];
                }
